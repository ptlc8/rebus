...
checkEquals(
    ...
    "il saʒi dyn ʁəpʁesɑ̃tasiɔ̃ mitoloʒik də lamuʁ, pəʁsɔnalise paʁ ɛ̃ kypidɔ̃ ɛle ki pʁɑ̃ le tʁɛ dɛ̃ adoləsɑ̃ suʁiɑ̃ ɛ ɑ̃tiɛʁəmɑ̃ ny."
);
checkEquals(
    ...
    "lə diø tjɛ̃ de flɛʃ a la mɛ̃ ɛ il ful o pie difeʁɑ̃ sɛ̃bol aʁtistik ɛ siɑ̃tifik (ɛ̃stʁymɑ̃ də mysik abime, ɛ̃stʁymɑ̃ də məsyʁ, livʁ, kɥiʁas daʁmyʁ, ətk.) siɲifiɑ̃ ɛ̃si la sypʁemasi də lamuʁ syʁ tut ʃos — du lə titʁ aktyəl, tiʁe dy vɛʁ ovidjɛ̃ ɔmnia vɛ̃si amɔʁ, səst-a-diʁ : « lamuʁ tʁiɔ̃f də tu »."
);
checkEquals(
...
checkEquals(
    ...
    "ɑ̃ ɔmaʒ o kɔmɑ̃ditɛʁ, plysiøʁ elemɑ̃ pʁesɑ̃ dɑ̃ lə tablo mətɑ̃ ɑ̃ lymiɛʁ sɔ̃ idɑ̃tite ɛ se vəʁty, a tʁavɛʁ yn sɛ̃bolik kɔ̃pləks dɔ̃ le kle fɔ̃ ɑ̃kɔʁ deba."
);
checkEquals(
...
checkEquals(toRebus("L'arnaqueur de paris vend son âme au démon"), "🥓n🅰️❤️ 2️⃣ 🍰i 🍃 🔊 🅰️m 💧 🎲🗻");
...
checkEquals(
    ...
    "🗡️our vikt🥇i🥚 ou 🅰️mour 🍷❤️ è 1️⃣ 🕸 🍺 🟢 1601 ou 1602 🍰 🥓tist lonb🅰️r mich🇪l👼🇪l💧 m🇪🍚🪚, di « 🚌🅰️v🅰️j », 🅰️l🥇 kil vi è t🐀v🧄 🅰️ 🥃."
);