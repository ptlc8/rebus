...
checkEquals(
    ...
    "lamuʁ viktɔʁjø u amuʁ vɛ̃køʁ ɛ yn twal pɛ̃t vɛʁ 1601 u 1602 paʁ laʁtist lɔ̃baʁ miʃəlɑ̃ʒəlo məʁizi, di « kaʁavaʒ », alɔʁ kil vi e tʁavaj a ʁɔm."
);
checkEquals(
    ...
    "il saʒi dyn ʁəpʁezɑ̃tasjɔ̃ mitoloʒik də lamuʁ, pɛʁsɔnalize paʁ ɛ̃ kypidɔ̃ ɛle ki pʁɑ̃ le tʁɛ dɛ̃ adolesɑ̃ suʁjɑ̃ e ɑ̃tjɛʁəmɑ̃ ny."
);
checkEquals(
    ...
    "lə djø tjɛ̃ de flɛʃ a la mɛ̃ e il ful o pje difeʁɑ̃ sɛ̃bol aʁtistik e sjɑ̃tifik (ɛ̃stʁymɑ̃ də myzik abime, ɛ̃stʁymɑ̃ də məzyʁ, livʁ, kɥiʁas daʁmyʁ, ətk.) siɲifjɑ̃ ɛ̃si la sypʁemasi də lamuʁ syʁ tut ʃoz — du lə titʁ aktyɛl, tiʁe dy vɛʁ ovidjɛ̃ ɔmnja vɛ̃si amɔʁ, sɛ-a-diʁ : « lamuʁ tʁjɔ̃f də tu »."
);
checkEquals(
...
checkEquals(
    ...
    "la twal temwaɲ eɡaləmɑ̃ də la fɔʁt ʁivalite ɑ̃tʁ pɛ̃tʁ dɑ̃ lə miljø ʁɔmɛ̃ dy deby dy ksvii sjɛkl, notamɑ̃ ɑ̃tʁ kaʁavaʒ e ʒjovani baɡljɔn, ki, ʁələvɑ̃ lə defi, pʁodɥi lɥi osi ɛ̃ amuʁ divɛ̃ puʁ lə kaʁdinal bənədeto ʒjystinjani, fʁɛʁ dy maʁki."
);
...
checkEquals(
    ...
    "lə kamjɔ̃-bɛn də bɛn tʁavɛʁs la tɛʁ dɛʁjɛʁ la sɛʁ pɑ̃dɑ̃ kɛ̃ ʁɛn paʁesø ʁɑ̃vɛʁs yn bʁwɛt plɛn də fuʁʃɛt pʁɛ də la mɛs, e kə la mjɛn eklabus sa fɛs kɔ̃tʁ yn pjɛʁ ɑ̃teʁe su de pasəʁɛl ɑ̃sjɛn."
);
checkEquals(
...
checkEquals(
    ...
    "pɑ̃dɑ̃ sɔ̃ ʒoɡiŋ, la pi, ki obsɛʁvɛ de pi, dəmɑ̃da a oɡi syʁ sɔ̃ boɡi : « fot-il syɡʒeʁe yn syɡʒɛstjɔ̃, ɔʁɡanize yn paʁti, pʁevwaʁ de paʁti, anyle yn sɔʁti, defɑ̃dʁ yn demokʁasi, kɔ̃paʁe de demokʁasi, u ʁakɔ̃te yn peʁipesi ? »"
);
...
checkEquals(
    ...
    "🗡️our 🧬kt🥇👀 ou 🅰️mour 🍷❤️ è 1️⃣ 🕸️ 🍺 🪱 1601 ou 1602 🍰 🥓tℹ️st lonb🎨 mℹ️ch🇪‌l👼🇪‌l💧 m🇪‌🍚zℹ️, dℹ️ « 🚌🅰️v🅰️🎮 », 🅰️l🥇 k🏝️ 🧬 é t🐀v🧄 🅰️ 🥃."
);
